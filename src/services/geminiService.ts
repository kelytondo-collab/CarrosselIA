...
Estilo: Fotografia cinematográfica profissional, alta qualidade.
Formato: ${format === '9:16' ? 'vertical retrato (9:16)' : format === '4:5' ? 'ligeiramente vertical (4:5)' : 'quadrado (1:1)'}.
SEM texto, marcas d'água ou logos na imagem.`
  ...
  if (!imagePart?.inlineData) throw new Error('Imagem não gerada')
